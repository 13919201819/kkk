...
//   // Show all solutions on services page, only first 6 elsewhere
//   const displayedSolutions = isServicesPage ? solutions : solutions.slice(0, 6);

//   return (
//     <section className={styles.section}>
//       <h2 className={styles.heading}>
//         {isServicesPage ? "Our Complete Range of Services" : "Solutions we offer"}
//       </h2>
//       <div className={styles.grid}>
//         {displayedSolutions.map((sol, idx) => (
//           <motion.div
...
//       {/* Show More button only when NOT on services page */}
//       {!isServicesPage && (
//         <div className={styles.moreButtonWrapper}>
//           <Button text="More" onClick={handleMoreClick} />
//         </div>
