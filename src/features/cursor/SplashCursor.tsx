...
//           "OES_texture_half_float_linear"
//         );
//         halfFloatTexType = halfFloatExt?.HALF_FLOAT_OES ?? gl.FLOAT;
//       }
...
//       copyProgram.bind();
//       if (copyProgram.uniforms.uTexture && gl)
//         gl.uniform1i(copyProgram.uniforms.uTexture, target.attach(0));
//       blit(newFBO, false);
//       return newFBO;
//     }
...
//       if (!newRead || !newWrite) return null;
//       target.read = newRead;
...
//       const texType = ext.halfFloatTexType;
//       const rgbaInternal = gl.RGBA;
//       const rgbaFormat = gl.RGBA;
//       const rgInternal = gl.RGBA; // Fallback to RGBA
//       const rgFormat = gl.RGBA;
//       const rInternal = gl.RGBA; // Fallback to RGBA
//       const rFormat = gl.RGBA;
//       const filtering = ext.supportLinearFiltering ? gl.LINEAR : gl.NEAREST;
//       gl.disable(gl.BLEND);
...
//       if (!gl || !ext || !dye || !velocity || !divergence || !curl || !pressure) return;
...
//     halfFloat = ext as HalfFloatExtension | null;
...
//   let formatRGBA: TextureFormat = { internalFormat: gl.RGBA, format: gl.RGBA };
//   let formatRG: TextureFormat = { internalFormat: gl.RGBA, format: gl.RGBA };
//   let formatR: TextureFormat = { internalFormat: gl.RGBA, format: gl.RGBA };
